...
{
    // for simplification purposes, use an in-memory datastore as a fake "manager list"
    ...
    /// <summary>
    /// For simplification purposes, write out the data store to the console window
    /// </summary>
...
public class AddEmployeeToManagerList : ICommand
{
    ...
    public AddEmployeeToManagerList(IEmployeeManagerRepository employeeManagerRepository, int managerId,
        Employee? employee)
    {
...
public class CommandManger
{
    ...
    {
        // if the command has not been store yet, store it - we will
